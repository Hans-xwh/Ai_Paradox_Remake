...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(983, 621);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(183, 67);
			this->button1->TabIndex = 0;
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Creditos::button1_Click);
			// 
			// Creditos
			// 
			...
			this->ClientSize = System::Drawing::Size(1165, 688);
